	...
	<div class="footer-inner">
		...
		<nav class="footer-link">
			...
			<div class="box">
				...
				<ul class="list">
					...
					<li><a href="javascript:void(0);"
						onclick="layer.open('layerQnAselect');">고객의 소리</a></li>
				</ul>
			</div>
			<div class="sns">
				<ul>
					<li class="facebook"><a
						href="https://www.facebook.com/Hfashionmall" target="_blank">Facebook</a></li>
					<li class="post"><a href="https://blog.naver.com/h_edit"
						target="_blank">Post</a></li>
					<li class="insta"><a
						href="https://www.instagram.com/hfashionmall_official"
		...
		<div class="footer-info">
			<p>
				...
				: 윤인수<br>호스팅서비스 : (주)한섬 <a
					href="http://www.ftc.go.kr/bizCommPop.do?wrkr_no=1208126337"
					target="_blank">사업자정보확인</a>
				<button type="button" onclick="openLayerPayInfo()">채무지급보증안내</button>
			</p>
			<p class="contact">
				<span>전화 1800-5700(유료)</span><span>팩스 02-476-8169</span><span>이메일
					<a href="mailto:hfashionmall@hyundaihmall.com">hfashionmall@hyundaihmall.com</a>
				</span>
			</p>
		</div>
	</div>
